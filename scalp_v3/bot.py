...
def get_ema_120_1_binance():
	...
	df["EMA 120-1 Close"] = ta.trend.EMAIndicator(
		df["Close"], window=120
	).ema_indicator()
...
def get_ema_120_5_binance():
	...
	df["EMA 120-5 Close"] = ta.trend.EMAIndicator(
		df["Close"], window=120
	).ema_indicator()
...
def get_ema_240_1_binance():
	...
	df["EMA 240-1 Close"] = ta.trend.EMAIndicator(
		df["Close"], window=240
	).ema_indicator()
...
def get_ema_240_5_binance():
	...
	df["EMA 240-5 Close"] = ta.trend.EMAIndicator(
		df["Close"], window=240
	).ema_indicator()
...
while True:
	...
	ma_order_long_1m = (
		ema_60_1_binance < ema_120_1_binance
		and ema_120_1_binance < ema_240_1_binance
		and ema_3_1_high_bybit < ema_60_1_binance
	)
	ma_order_long_5m = (
		ema_60_5_binance < ema_120_5_binance
		and ema_120_5_binance < ema_240_5_binance
		and ema_3_5_high_bybit < ema_60_5_binance
	)

	ma_order_shrt_1m = (
		ema_60_1_binance > ema_120_1_binance
		and ema_120_1_binance > ema_240_1_binance
		and ema_3_1_low_bybit > ema_60_1_binance
	)
	ma_order_shrt_5m = (
		ema_60_5_binance > ema_120_5_binance
		and ema_120_5_binance > ema_240_5_binance
		and ema_3_5_low_bybit > ema_60_5_binance
	)
	...
	good_shrt_conditions = (
		good_ma_order_shrt == True
		and ask > ema_3_5_high_bybit
		and ask > ema_3_1_high_bybit
	)
	# good_long_conditions = good_ma_order_long == True and bid < ema_3_5_low_bybit and bid < ema_3_1_low_bybit
	good_long_conditions = (
		good_ma_order_long == True
		and ask > ema_3_5_high_bybit
		and ask > ema_3_1_high_bybit
	)
	...
	profit = 100 - (
		(float(available_balance) - float(realised_pnl))
		* 100
	...
	if sell_position_size > 0:
		...
		sell_tp_price = round(
			sell_position_prce - (ema_6_1_high_bybit - ema_6_1_low_bybit), decimals
		)
